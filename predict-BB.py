...
with tf.device('/gpu:2'):
    APN= tf.keras.models.load_model('Models/Black-Background-model.h5',compile= False)
...
with tf.device('/GPU:2'):
    ...
    masks_save_dir = 'Predicted_test_Black/'
    ...
    for image_name in original:
        ...
        predicted_mask = prediction_pillow(original_image, APN)
        ...
        original_image_np[np.where(resized_mask_pil == 0)] = [0, 0, 0]
